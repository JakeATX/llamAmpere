...
function(ggml_cuda_fattn_vec_instances DIR OUT_SRCS)
    ...
    foreach (TURBO IN LISTS FA_TURBO_TYPES)
        list(APPEND FA_TURBO_COMBINATIONS
            ${TURBO}-${TURBO} ${TURBO}-q8_0 q8_0-${TURBO} f16-${TURBO} ${TURBO}-f16)
        foreach (OTHER IN LISTS FA_TURBO_TYPES)
            if (NOT TURBO STREQUAL OTHER)
                list(APPEND FA_TURBO_COMBINATIONS ${TURBO}-${OTHER})
            endif()
        endforeach()
    endforeach()
    ...
    set(FA_ALL_TYPES ${FA_TYPES} ${FA_TURBO_TYPES})
