...
([docs/bonsai2.md](docs/bonsai2.md)), an opt-in shared-memory codebook for IQ3 decode, and an upstream
llama.cpp catch-up. The ATX IQ4_XS configuration below is unchanged; see
