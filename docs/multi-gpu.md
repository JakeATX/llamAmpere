...
| Startup error *"LLAMA_SPLIT_MODE_TENSOR not implemented for EXL3 weights"* | EXL3 (exllamav3 trellis) weights cannot be tensor-split. Use `--split-mode layer` or a single GPU. See `docs/exl3.md`. |
